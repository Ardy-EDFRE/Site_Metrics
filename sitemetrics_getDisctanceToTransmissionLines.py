...
# By default point to velocity suite subs and lines
# User can select minimum and maximum voltage of interest (ie, 115 - 345 kV)
# User can select In Service Only, or also Proposed
#
# Output Fields:
#   Name of Nearest Substation Target
#   Miles to that Substation Target
#   Name of Nearest Transmission Line Target
#   Miles to that Transmission Target
